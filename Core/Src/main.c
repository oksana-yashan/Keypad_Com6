...
//	  //Transmit data through COM6 to PC
//	  CDC_Transmit_FS((unsigned char*)str_tx, strlen(str_tx));
//	  HAL_Delay(500);
//
//
//	  //Receive data through COM6 to Display from PC
//
//	  Display_Write_Ins(GO_TO_START_FIRST_LINE);
//	  for (int i=0; i<strlen(str_rx); ++i) {
//	  		  Display_Write_Data(str_rx[i]);
//	  }
//	  for(i=1;i<((uint8_t)(16-strlen(str_rx)));i++)
//	  		  Display_Write_Data(' ');
//	  HAL_Delay(500);
